        ...
        <main>
            <div class="main">
                <div class="container-main">
                    <h1>True Slavs ||| Present:</h1>
                    <h1 class="main-text">Kompot OF Rhytms</h1>
                    <h2 class="subtitle">Life is too short not to share music!</h2>
                    <div class="center">
        ...
        <footer>
            <div class="footer">
                <div class="container-foot">
                    <h1>We do not own any of the rights regarding the music we post. It's only for entertainment purposes! True Slavs |||</h1>
                </div>
            </div>
        </footer>
